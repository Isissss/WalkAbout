    ...
    <Dialog.Root defaultOpen={false} open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className='fixed left-[50%] top-[50%] grid max-h-[99vh] w-[90vw] max-w-lg translate-x-[-50%] translate-y-[-50%] place-items-center overflow-y-auto rounded-lg bg-white p-5 shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none data-[state=open]:animate-contentShow'
        >
          <Dialog.Description>
