  ...
  return (
    <>
      ...
      <div className='flex w-full gap-2 max-lg:block'>
        <div className='flex w-1/2 max-lg:w-full flex-col gap-2'>
          <div className='flex justify-between rounded-3xl border-2 border-foreground p-2 text-black no-underline'>
            ...
            <img
              src='/women.png'
              alt=''
              className='h-52 w-72 max-lg:w-52 rounded-3xl object-cover'
            />
          </div>
                  ...
                  >
                      <div className='col-span-1 overflow-hidden max-md:hidden'>
                          <img
                              src={dummy}
                              alt=''
                              className='h-full w-full md:h-52  rounded-3xl object-cover'
                          />
                      </div>
          ...
          <div
              className='flex w-1/2 max-lg:w-full justify-center rounded-3xl border-2 border-foreground p-2 text-center text-black no-underline'>
              <div className='w-full text-2xl font-bold'>
                  ...
                  <div className='text-xl font-normal'>
                      <div className='flex gap-3 rounded-3xl border-2 border-foreground p-2 text-black no-underline'>
                          <img
                              src='/coffee.jpg'
                              alt=''
                              className='h-52 w-72 max-md:w-24 max-md:h-32 rounded-3xl object-cover'
                          />
                  ...
                  <div className='text-xl font-normal'>
                      <div
                          className='mt-2 flex gap-3 rounded-3xl border-2 border-foreground p-2 text-black no-underline'>
                          <img
                              src='/coffee.jpg'
                              alt=''
                              className='h-52 w-72 max-md:w-24 max-md:h-32 rounded-3xl object-cover'
        ...
        <section
            className='w-24 rounded-3xl border-2 border-foreground bg-orange-500 p-2 text-center text-2xl font-bold text-black no-underline'>
